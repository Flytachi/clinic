...
class UserModel extends Model
{
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Филиал:</label>
                                    <select data-placeholder="Выбрать филиал" name="branch_id" class="<?= $classes['form-select'] ?>" required>
                                        <option></option>
                                        <?php foreach ($db->query("SELECT * FROM corp_branchs") as $row): ?>
                                            <option value="<?= $row['id'] ?>" <?= ($this->value('branch_id') == $row['id']) ? 'selected': '' ?>><?= $row['name'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
    ...
    public function form_manager($pk = null) 
    {
