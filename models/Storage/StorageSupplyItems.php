...
class StorageSupplyItemsModel extends Model
{
    ...
    public function form($pk = null)
    {
        ...
        <?php endif; ?>
            ...
            <td>
                <input type="number" name="item_qty" <?= $status ?> class="form-control" min="1" placeholder="№" value="<?= $this->value('item_qty') ?>" onkeyup="UpBtn('btn_save-<?= $this->number ?>')">
            </td>
            <td>
                <input type="number" name="item_cost" <?= $status ?> class="form-control" min="0" placeholder="Введите цену" value="<?= $this->value('item_cost') ?>" onkeyup="UpBtn('btn_save-<?= $this->number ?>')">
            </td>
            <td>
                <input type="number" name="item_price" <?= $status ?> class="form-control" min="0" placeholder="Введите цену" value="<?= $this->value('item_price') ?>" onkeyup="UpBtn('btn_save-<?= $this->number ?>')">
            </td>
            <td>
                <input type="text" name="item_faktura" <?= $status ?> class="form-control" placeholder="Введите № фактуры" value="<?= $this->value('item_faktura') ?>" onkeyup="UpBtn('btn_save-<?= $this->number ?>')">
            </td>
            <td>
                <input type="text" name="item_shtrih" <?= $status ?> class="form-control" placeholder="Введите штрих" value="<?= $this->value('item_shtrih') ?>" onkeyup="UpBtn('btn_save-<?= $this->number ?>')">
            </td>
            <td>
                <input type="date" name="item_die_date" <?= $status ?> class="form-control daterange-single" value="<?= $this->value('item_die_date') ?>" onchange="UpBtn('btn_save-<?= $this->number ?>')">
            </td>
