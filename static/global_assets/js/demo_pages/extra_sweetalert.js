    ...
    var _componentSweetAlert = function () {
            ...
            swal({
                ...
                if (ivi.value) {
                    let mess =
                        ...
                        parent +
                        "<br> <strong>Расположение: </strong>" +
                        $("#patient_location").text();
                    let obj = JSON.stringify({
                        type: "call_nurce_to_doc",
                        id: grant_id,
                        message: mess,
                    });
                    conn.send(obj);
            ...
            swal({
                ...
                if (result.value) {
                    swal({
                        ...
                        html:
                            'Submitted email: <span class="font-weight-semibold">' +
                            result.value +
                            "</span>",
                    });
                }
        ...
        $("#sweet_html").on("click", function () {
            swal({
                ...
                html:
                    ...
                    '<a href="http://demo.interface.club">links</a> ' +
                    'and other <span class="text-warning">HTML tags</span>',
            });
        });
        ...
        $("#sweet_bg").on("click", function () {
            swal({
                ...
                background:
                    "#fff url(../../../../global_assets/images/backgrounds/seamless.png) repeat",
            });
        });
        ...
        $("#sweet_chain").on("click", function () {
            ...
            swal.setDefaults({
                input: "text",
                confirmButtonText:
                    'Next <i class="icon-arrow-right14 ml-2"></i>',
            ...
            swal.queue(steps).then(
                function (result) {
                    ...
                    swal({
                        title: "All done!",
                        html:
                            'Your answers: <pre class="mt-3"><code>' +
        ...
        $("#sweet_checkbox").on("click", function () {
            swal({
                ...
                confirmButtonText:
                    'Continue <i class="icon-arrow-right14 ml-2></i>',
                inputValidator: function (value) {
                ...
                if (result.value) {
                    swal({
                        ...
                        html:
                            "You selected: " +
                            JSON.stringify(
                                $(".swal2-select.select-multiple").val()
                            ),
                    });
                }
            });
    ...
    var _componentMultiselect = function () {
        ...
        $("#sweet_multiselect").on("click", function () {
            swal({
                ...
                inputValidator: function (value) {
                    return (
                        !$(".swal2-select.select-multiselect").val().length &&
                ...
                swal({
                    ...
                    html:
                        "You selected: " +
                        JSON.stringify(
                            $(".swal2-select.select-multiselect").val()
                        ),
                });
        ...
        $("#sweet_checkbox_custom").on("click", function () {
            swal({
                ...
                onOpen: function () {
                    // Initialize Uniform for custom checkboxes
                    $(
                        ".swal2-checkbox.form-check-styled input[type=checkbox]"
                    ).uniform();
                },
            }).then(function (result) {
                if (result.value) {
        ...
        $("#sweet_radio_custom").on("click", function () {
            ...
            swal({
                ...
                onOpen: function () {
                    ...
                    $(
                        ".swal2-radio.form-check-styled input[type=radio]"
                    ).uniform();
                },
            }).then(function (result) {
                if (result.value) {
