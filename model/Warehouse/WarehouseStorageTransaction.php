...
class WarehouseStorageTransactionModel extends Model
{
    ...
    public function clean()
    {
        ...
        if ($object['item_qty'] != $this->post['item_qty']) $q = HellCrud::update($this->storage, array('item_qty' => $object['item_qty']-$this->post['item_qty']), $object['id']);
        else $q = HellCrud::delete($this->storage, $object['id']);
        ...
        HellCrud::insert($this->table, $transaction_post);
