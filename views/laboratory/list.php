					...
					<div class="card-body">
						...
						<div class="table-responsive">
                            <table class="table table-hover table-sm datatable-basic">
                                ...
                                <tbody>
                                    <?php
									$sql = "SELECT DISTINCT us.id, vs.route_id, us.dateBith, vs.direction
											FROM users us LEFT JOIN visit vs ON(us.id=vs.user_id)
											WHERE vs.completed IS NULL AND vs.status = 2 AND vs.laboratory IS NOT NULL AND vs.accept_date IS NOT NULL ORDER BY vs.accept_date DESC";
