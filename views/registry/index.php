				...
				<div class="<?= $classes['card'] ?>">
					...
					<div class="<?= $classes['card-header'] ?>">
						...
						<div class="header-elements">
							...
							<a onclick="Update('<?= up_url(null, 'ClientModel') ?>')" class="btn bg-success btn-icon ml-2 legitRipple"><i class="icon-plus22"></i></a>
						</div>
					</div>
										...
										<tr>
											...
											<td class="text-center">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(1153px, 186px, 0px);">
													...
													<a onclick="Update('<?= up_url($row->id, 'ClientModel') ?>')" class="dropdown-item"><i class="icon-quill2"></i>Редактировать</a>
                                                </div>
											</td>
										</tr>
									<?php endforeach;?>
