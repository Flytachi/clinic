					...
					<div class="card-body">
						...
						<div class="table-responsive card">
				            <table class="table table-hover table-sm">
				                ...
				                <tbody>
                                    <?php foreach ($db->query("SELECT DISTINCT user_id, parent_id FROM storage_orders WHERE date = CURRENT_DATE()") as $row): ?>
                                        <tr onclick="Check('<?= viv('pharmacy/application_reparat') ?>?pk=<?= $row['user_id'] ?>')">
