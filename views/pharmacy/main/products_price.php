...
<div class="container-fluid">
	...
	<div class="span10">
	  <h2>Препараты с фиксированной ценой
      </h2>
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				$result = $db->prepare("SELECT * FROM products where catg = 'Фиксированная' ORDER BY product_id DESC");
				$result->execute();
			...
			?>
			</td>			<td><a rel="facebox" title="Редактировать" href="editproduct.php?id=<?php echo $row['product_id']; ?>"><button class="btn btn-warning"><i class="icon-edit"></i> </button> </a>
