...
<table width="858px" height="10%" border="1" cellpadding="0" cellspacing="0" id="filter" style="font-family: arial; font-size: 19px; text-align: center;">
	    <thead>
	      <tr id="resultTable">
	        <th height="29" colspan="4">OOO "BUXORO GIYOH FARM" <span style="text-align: center"></span></th>
	        </tr>
	      <tr>
	        <th width="629" height="50" id="resultTable" >&nbsp&nbsp&nbspНаименование&nbsp&nbsp&nbsp</th>
	        <th width="40"><p>кол-во</p></th>
	        <th width="82">Цена </th>
	        <th width="97" nowrap="nowrap"> Всего </th>
	        </tr>
	      </thead>
	    <tbody>
	      <?php
	      ...
	      <tr>
	        <td height="30" colspan="2" valign="top" id="resultTable" style="text-align: left;"><p><strong>Дата <?php echo $date ?><br>Время:
