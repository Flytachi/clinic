...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i>Препараты-ЖНВЛС</div>
			<ul class="breadcrumb">
...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Назад</button></a>
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM products WHERE catg = 'ЖНВЛС' ORDER BY qty_sold DESC");
				$result->execute();
			...
			<?php 
			include('../connect.php');
				$result = $db->prepare("SELECT * FROM products where catg = 'ЖНВЛС' ORDER BY product_id DESC");
				$result->execute();
