<div class="card border-1 border-info">
    ...
    <div class="card-body">
        ...
        <?php
        // prit($db->query("SELECT bd.ward, bd.num, bd.types, vs.user_id, vs.grant_id, vs.add_date, vs.discharge_date, us.dateBith FROM beds bd LEFT JOIN visit vs ON (vs.user_id=bd.user_id) LEFT JOIN users us ON (us.id=bd.user_id) WHERE bd.user_id IS NOT NULL AND bd.floor = 1 AND vs.completed IS NULL AND vs.grant_id = vs.parent_id")->fetchall());
        ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(1153px, 186px, 0px);">
                                    <a href="<?= viv('nurce/card/content_1') ?>?id=<?= $row['user_id'] ?>" class="dropdown-item"><i class="icon-users4"></i>Лист назначений</a>
