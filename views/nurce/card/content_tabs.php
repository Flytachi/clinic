...
<ul class="nav nav-tabs nav-tabs-highlight">
    ...
    <li class="nav-item">
        <a href="<?= viv('nurce/card/content_3') ?>?id=<?= $_GET['id'] ?>" class="nav-link <?= (viv('nurce/card/content_3')== $_SERVER['PHP_SELF']) ? "active": "" ?> legitRipple">Анализы<i class="icon-compose ml-3"></i></a>
    </li>
    <li class="nav-item">
        <a href="<?= viv('nurce/card/content_4') ?>?id=<?= $_GET['id'] ?>" class="nav-link <?= (viv('nurce/card/content_4')== $_SERVER['PHP_SELF']) ? "active": "" ?> legitRipple">Блюда<i class="icon-spinner11 ml-3"></i></a>
    </li>
    <li class="nav-item">
        <a href="<?= viv('nurce/card/content_5') ?>?id=<?= $_GET['id'] ?>" class="nav-link <?= (viv('nurce/card/content_5')== $_SERVER['PHP_SELF']) ? "active": "" ?> legitRipple">Состаение<i class="icon-bubble9 ml-3"></i></a>
    </li>
    <li class="nav-item">
