...
<ul class="nav nav-tabs nav-tabs-highlight">
    ...
    <li class="nav-item">
        <a href="<?= viv('nurce/card/content_3') ?>?id=<?= $_GET['id'] ?>" class="nav-link <?= (viv('nurce/card/content_3')== $_SERVER['PHP_SELF']) ? "active": "" ?> legitRipple">Анализы<i class="icon-fire2 ml-3"></i></a>
    </li>
    <li class="nav-item">
