...
<ul class="nav nav-tabs nav-tabs-solid nav-justified rounded border-0">
    ...
    <li class="nav-item">
        <a href="<?= viv('nurce/card/content_2') ?>?id=<?= $_GET['id'] ?>" class="nav-link <?= (viv('nurce/card/content_2')== $_SERVER['PHP_SELF']) ? "active": "" ?> legitRipple" style="white-space:nowrap;"><i class="icon-magazine mr-1"></i>Лист назначений</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a href="<?= viv('nurce/card/content_4') ?>?id=<?= $_GET['id'] ?>" class="nav-link <?= (viv('nurce/card/content_4')== $_SERVER['PHP_SELF']) ? "active": "" ?> legitRipple" style="white-space:nowrap;"><i class="icon-fire2 mr-1"></i>Анализы</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a href="<?= viv('nurce/card/content_6') ?>?id=<?= $_GET['id'] ?>" class="nav-link <?= (viv('nurce/card/content_6')== $_SERVER['PHP_SELF']) ? "active": "" ?> legitRipple" style="white-space:nowrap;"><i class="icon-clipboard2 mr-1"></i>Состояние</a>
    </li>
    <li class="nav-item">
