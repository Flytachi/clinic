			...
			<div class="content">
				...
				<div class="<?= $classes['card'] ?>">
					...
					<div class="card-body">
						...
						<?php if( config('check_logotype') ): ?>
							<div class="row">
								<div class="col-md-6">
									<div class="image-cropper-container mb-3">
										<img src="<?= ( config('check_logotype') ) ? config('check_logotype') : stack('global_assets/images/placeholders/placeholder.jpg') ; ?>" alt="" class="cropper crop-drag" id="demo-cropper-image">
									</div>
						...
						<?php else: ?>
							<form action="<?= ajax('admin/check') ?>" method="post" enctype="multipart/form-data">
								...
								<fieldset class="mb-3">
									...
									<div class="form-group row">
										...
										<div class="col-lg-9">
											<input type="file" name="constant_check_logotype" class="form-control">
										</div>
									</div>
