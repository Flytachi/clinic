				...
				<div class="<?= $classes['card'] ?>">
				    ...
				    <div class="card-body">
						...
						<legend class="font-weight-semibold font-size-sm">
							...
							<?php if ( $activity and permission(11) and (!$patient->direction or ($patient->direction and (config('card_stationar_diagnostic_button') or is_grant()) )) ): ?>
							...
							<?php endif; ?>
							<?php if ( module('module_zetta_pacs') and permission(11) ): ?>
								<?php 
								$zeT = zeTTa_data();
								$message_z = "";
							...
							<div class="table-responsive">
								<table class="table table-hover table-sm">
									...
									<tbody>
										...
										$tb->set_data("id, division_id, route_id, responsible_id, accept_date, completed, service_name, status")->where("visit_id = $patient->visit_id AND level = 12")->order_by('add_date DESC');
										?>
