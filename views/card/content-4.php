							...
							<div class="table-responsive">
								<table class="table table-hover table-sm">
									...
									<tbody>
										...
										$tb->set_data("id, route_id, division_id, responsible_id, accept_date, completed, service_name, status")->where("visit_id = $patient->visit_id AND level = 11 AND route_id != $session->session_id AND responsible_id != $session->session_id AND service_id != 1")->order_by('add_date DESC');
										?>
