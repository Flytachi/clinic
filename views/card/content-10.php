							...
							<div class="table-responsive">
								<table class="table table-hover table-sm">
									...
									<tbody>
										...
										$tb->set_data("id, division_id, route_id, responsible_id, accept_date, completed, service_name, status")->where("visit_id = $patient->visit_id AND level = 14")->order_by('add_date DESC');
										?>
