										...
										?>
											<tr>
												...
												<td class="text-center">
													<?php if ($row['physio']): ?>
														<button onclick="Check('<?= viv('physio/report') ?>?pk=<?= $row['id'] ?>')" class="btn btn-outline-info btn-sm legitRipple"><i class="icon-eye mr-2"></i> Просмотр</button>
													<?php elseif ($row['manipulation']): ?>
														<button onclick="Check('<?= viv('manipulation/report') ?>?pk=<?= $row['id'] ?>')" class="btn btn-outline-info btn-sm legitRipple"><i class="icon-eye mr-2"></i> Просмотр</button>
													<?php endif; ?>
												</td>
											</tr>
										<?php
