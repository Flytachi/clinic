<ul class="nav nav-tabs nav-tabs-solid nav-justified rounded border-0">
    ...
    <?php endif; ?>
    <?php if ( $activity and $patient->direction and !permission(15) ): ?>
        <li class="nav-item">
    ...
    <?php endif; ?>
    <?php if ( ($activity or !$patient->direction) and !permission(15) ): ?>
        <li class="nav-item">
    ...
    <?php endif; ?>
    <?php if( module('module_bypass') and $patient->direction ): ?>
        <li class="nav-item">
    ...
    <?php endif; ?>
    <?php if( module('module_physio') and !permission(15) ): ?>
        <li class="nav-item">
