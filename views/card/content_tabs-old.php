...
<ul class="nav nav-tabs nav-tabs-solid nav-justified rounded border-0">
    <span class="text-danger">Старый tab</span>
    ...
    <?php if (!$activity or permission([5])): ?>
        <?php if ( !$patient->direction or ($activity and !$patient->completed) ): ?>
            <li class="nav-item">
    ...
    <?php if (!$activity or !permission([11])): ?>
        <?php if ( !$patient->direction or ($activity and !$patient->completed) ): ?>
            <li class="nav-item">
                <a href="<?= viv('card/content_3').$agr ?>" class="nav-link <?= viv_link('card/content_3') ?> legitRipple" style="white-space:nowrap;"><i class="icon-add mr-1"></i>Назначенные услуги</a>
            </li>
        <?php else: ?>
            <li class="nav-item">
                <a href="<?= viv('card/content_3').$agr ?>" class="nav-link <?= viv_link('card/content_3') ?> legitRipple" style="white-space:nowrap;"><i class="icon-add mr-1"></i>Услуги</a>
            </li>
        <?php endif; ?>
    <?php endif; ?>
