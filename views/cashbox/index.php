...
$tb = (new VisitModel)->as('v')->Data("DISTINCT vs.visit_id, v.client_id, c.first_name, c.last_name, c.father_name");
$search = $tb->getSearch();
$tb->Join("LEFT JOIN visit_services vs ON(vs.visit_id=v.id) LEFT JOIN clients c ON(c.id=v.client_id)");
$where_search = array(
