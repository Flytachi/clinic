...
$session->is_auth();
$header = "Отчёт физиотерапии по услугам";
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content">
								...
								<div class="form-group row">
									...
									<div class="col-md-12">
										...
										<select data-placeholder="Выберите специалиста" name="responsible_id" id="responsible_id" class="<?= $classes['form-select'] ?>" required>
											<option></option>
											<?php foreach($db->query("SELECT * FROM users WHERE branch_id = $session->branch AND user_level = 14") as $row): ?>
				...
				<?php if ($_POST): ?>
					<?php
					$Iam = "vs.branch_id = $session->branch AND vs.level = 14"; 
