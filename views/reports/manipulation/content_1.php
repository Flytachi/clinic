			...
			<div class="content">
							...
							<div class="form-group row">
								...
								<div class="col-md-3">
									...
									<select id="service" name="service_id" class="form-control form-control-select2" data-fouc>
										...
										<?php
										foreach($db->query('SELECT * from service WHERE user_level = 13') as $row) {
											?>
								...
								<div class="col-md-3">
									...
									<select id="parent_id" name="parent_id" class="form-control form-control-select2" data-fouc>
										...
										<?php
										foreach($db->query('SELECT * from users WHERE user_level = 13') as $row) {
											?>
				...
				<?php if ($_POST): ?>
					...
					$sql = "SELECT
							...
							WHERE
								vp.item_type = 1 AND vs.accept_date IS NOT NULL AND ds.level = 13";
					// Обработка
