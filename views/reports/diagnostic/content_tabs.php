<ul class="nav nav-tabs nav-tabs-solid nav-justified rounded border-0">
    <li class="nav-item">
        <a href="<?= viv('reports/diagnostic/content_1') ?>" class="nav-link <?= (viv('reports/diagnostic/content_1')== $_SERVER['PHP_SELF']) ? "active show": "" ?> legitRipple">Услуги</a>
    </li>
    <li class="nav-item">
        <a href="<?= viv('reports/diagnostic/content_2') ?>" class="nav-link <?= (viv('reports/diagnostic/content_2')== $_SERVER['PHP_SELF']) ? "active show": "" ?> legitRipple">Визиты</a>
    </li>
</ul>
