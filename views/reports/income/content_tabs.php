<ul class="nav nav-tabs nav-tabs-solid nav-justified rounded border-0">
    <li class="nav-item">
        <a href="<?= viv('reports/income/content_1') ?>" class="nav-link <?= viv_link('reports/income/content_1') ?> legitRipple">Компания</a>
    </li>
    <li class="nav-item">
        <a href="<?= viv('reports/income/content_2') ?>" class="nav-link <?= viv_link('reports/income/content_2') ?> legitRipple">Специолист</a>
    </li>
</ul>
