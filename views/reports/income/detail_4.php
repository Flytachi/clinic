...
$sql = "SELECT vs.priced_date, vs.user_id, ds.title, vp.item_name, (vp.price_cash + vp.price_card + vp.price_transfer) 'price' 
        FROM visit vs 
        ...
        WHERE vs.direction IS NOT NULL AND sc.type = 1 AND vs.parent_id = {$_POST['parent_id']} 
