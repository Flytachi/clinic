						...
						<div class="table-responsive">
			                <table class="table table-hover table-columned">
			                    ...
			                    <tbody>
									<?php
									$i = 1;
									foreach ($db->query("SELECT id, parent_id, direction, accept_date, completed FROM visit WHERE user_id = $patient->user_id AND completed IS NOT NULL AND parent_id = {$_SESSION['session_id']} ORDER BY accept_date DESC") as $row) {
									?>
