...
<ul class="nav nav-tabs nav-tabs-solid nav-justified rounded border-0">
    ...
    <?php if ($patient->direction): ?>
        ...
        <li class="nav-item">
            <a href="<?= viv('doctor/card/content_10') ?>?id=<?= $_GET['id'] ?>" class="nav-link <?= (viv('doctor/card/content_10')== $_SERVER['PHP_SELF']) ? "active": "" ?> legitRipple" style="white-space:nowrap;"><i class="icon-fire mr-1"></i>Анестезия</a>
        </li>
    <?php endif; ?>
</ul>
