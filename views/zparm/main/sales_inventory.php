...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Инвентаризация продаж
			</div>
<br>
...
<button  style="float:left;" class="btn btn-success btn-mini"><a href="javascript:Clickheretoprint()"> Распечатать</button></a>
</div>
<br>
<br>
<br>
...
<br><br><br>
<center><strong>Таблица продаж</strong></center>
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="12%"> Номер чека </th>
			<th width="9%"> Дата </th>
			<th width="14%"> Название </th>
			<th width="16%"> Производитель </th>
			<th width="15%"> Серия </th>
			<th > Цена </th>
			<th> Количество </th>

			<th width="8%"> Сумма </th>
			<th width="8%"> Прибыль </th>
	...
	<tbody>
			...
			?></td>
			<td> 				
			<a href="deletesalesinventory.php?id=<?php echo $row['transaction_id']; ?>&qty=<?php echo $row['qty'];?>"><button class="btn btn-mini btn-danger"><i class="icon icon-trash"></i> Удалить </button></a>
			</tr>
			<?php
				}
			?>
			...
			<tr>
				<th colspan="7"><strong style="font-size: 20px; color: #222222;">Итог:</strong></th>
