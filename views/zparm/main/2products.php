...
<a  href="index.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Назад</button></a>
			...
			<div style="text-align:center;">
			<font style="color:rgb(255, 95, 66);; font:bold 22px 'Aleo';">[<?php echo $rowcount123;?>]</font> Препараты оставшиеся меньше 10 шт
			</div>
</div>
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				$availablcatg=$row['catg'];
				if ($availablcatg == 'ЖНВЛС') {
				echo '<tr class="alert alert-warning record" style="color: #000; background:#a8ffb2;);">';
				}
				elseif ($availablcatg == 'Фиксированная')
				{
				echo '<tr class="alert alert-warning record" style="color: #000; background:#a9cffd;);">';
				}
				else {
				echo '<tr class="record">';
				}
