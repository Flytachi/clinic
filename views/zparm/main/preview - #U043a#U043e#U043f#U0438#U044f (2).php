...
<script><body onload="window.print(); window.close();">
...
<table width="858px" height="10%" border="1" cellpadding="0" cellspacing="0" id="filter" style="font-family: arial; font-size: 19px; text-align: center;">
	    <thead>
	      <tr id="resultTable">
	        <th height="29" colspan="4"><?php echo 'OOO BUXORO GIYOH FARM' ; ?><span style="text-align: center"></span></th>
	        </tr>
	      <tr>
	        <th width="450" height="50" id="resultTable"> Название </th>
	        <th width="160"><p>кол-во</p></th>
	        <th width="131">Цена </th>
	        <th width="180" nowrap="nowrap"> Всего </th>
	        </tr>
	      </thead>
	    <tbody>
	      <?php
	      ...
	      <?php
				...
				?>
	      <tr>
	        <td height="15" colspan="3" id="resultTable" style=" text-align:right;"><strong style="font-size: 19px;">Итог: &nbsp;</strong></td>
	      ...
	      <tr>
	        <td height="30" colspan="2" valign="top" id="resultTable" style="text-align: left;"><p>Дата <?php echo $date ?>&nbsp&nbsp&nbsp Время:
