...
<?php // } ?>				
	...
	<div class="span10">
		<div class="contentheader">
			<i class="icon-money"></i> Продажы
			</div>
			<ul class="breadcrumb">
			<a href="index.php"><li>Панель управление</li></a> /
			<li class="active">Продажы</li>
			</ul>
...
<?php //$nal = $row['qty'];  ?>
<input type="hidden" name="nall" id = "nall" value="<?php echo $row['qty'];?>"/>
<input type="text" name="qty" id="qty" value="1" min="1" placeholder="ШТ" autocomplete="off" style="width: 68px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px;" />
...
<table class="table table-bordered" id="resultTable" data-responsive="table">
	...
	<tbody>
			...
			<td width="90"><a href="delete.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>"><button class="btn btn-mini btn-warning"><i class="icon icon-remove"></i> Отменить</button></a></td>
			</tr>
			<?php
				}
			?>
			...
			<tr>
				<th colspan="5"><strong style="font-size: 12px; color: #222222;">Всего:</strong></th>
...
<script src="vendors/chosen.jquery.min.js" type="text/javascript"></script>
<script>function srav(){    
  var diag_nap_uchr = document.getElementById('nall');  
  var diag_osn = document.getElementById('qty');
...
$(".chzn-select").chosen({
	...
	placeholder_text_single: "Введите название или отсканируйте баркод",
    width: "65%"
