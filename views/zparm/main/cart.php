		...
		<label>alphaware</label>
			...
			<?php
				$id = (int) $_SESSION['id'];
					...
					$query = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM customer WHERE customerid = '$id' ") or die (mysqli_error($GLOBALS["___mysqli_ston"]));
...
if (isset($_SESSION['cart']))
	...
	{
	$result=mysqli_query($GLOBALS["___mysqli_ston"], "Select * from product where product_id=$id");
