...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="customer.php"><i class="icon-group icon-2x"></i> Клиенты </a>                                    </li>
...
<?php 
			...
			Общее количество клиентов: <font color="green" style="font:bold 22px 'Aleo';"><?php echo $rowcount;?></font>
			</div>
</div>
<input type="text" name="filter" style="padding:15px;" id="filter" placeholder="Поиск по поставщикам..." autocomplete="off" />
<a rel="facebox" href="addcustomer.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Добавить клиента</button></a><br><br>

<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="17%"> Название </th>
			<th width="10%"> Адрес </th>
			<th width="10%"> Телефон</th>
			<th width="23%"> Название товара</th>
			<th width="9%"> Общая сумма </th>
			<th width="17%"> Заметки (р/с и т д...) </th>
			<th width="9%"> Сроки поставки </th>
	...
	<tbody>
			...
			<td><a  title="Click To Edit Customer" rel="facebox" href="editcustomer.php?id=<?php echo $row['customer_id']; ?>"><button class="btn btn-warning btn-mini"><i class="icon-edit"></i> Редактировать </button></a> 
			<a href="#" id="<?php echo $row['customer_id']; ?>" class="delbutton" title="Click To Delete"><button class="btn btn-danger btn-mini"><i class="icon-trash"></i> Удалить</button></a></td>
			</tr>
			<?php
				}
			?>
