...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
              ...
              <li><a href="index.php"><i class="icon-dashboard icon-2x">
			...
			<li class="active"><a href="salesreport.php?d1=0&d2=0"><i class="icon-bar-chart icon-2x"></i> Отчеты продаж</a>                </li>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Отчеты продаж
			</div>
			<ul class="breadcrumb">
			<li><a href="index.php">Панель управления</a></li> /
			<li class="active">Отчеты продаж</li>
			</ul>

<div style="margin-top: -19px; margin-bottom: 21px;">
<a  href="index.php"><button class="btn btn-default btn-large" style="float: none;"><i class="icon icon-circle-arrow-left icon-large"></i> Назад</button>
</a>
<button  style="float:right;" class="btn btn-success btn-mini"><a href="javascript:Clickheretoprint()"> Печать</button></a>

</div>
<form action="salesreport.php" method="get">
<center><strong>От : <input type="text" style="width: 223px; padding:14px;" name="d1" class="tcal" value="" /> До: <input type="text" style="width: 223px; padding:14px;" name="d2" class="tcal" value="" />
 <button class="btn btn-info" style="width: 123px; height:35px; margin-top:-8px;margin-left:8px;" type="submit"><i class="icon icon-search icon-large"></i> Показать</button>
</strong></center>
</form>
<div class="content" id="content">
<div style="font-weight:bold; text-align:center;font-size:14px;margin-bottom: 15px;"> Отчеты продаж от
&nbsp;<?php echo $_GET['d1'] ?>&nbsp;до&nbsp;<?php echo $_GET['d2'] ?>
</div>
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="13%"> ID Транзакции </th>
			<th width="13%"> Дата транзакции </th>
			<th width="20%"> Наименование клиента </th>
			<th width="16%"> Номер счета </th>
			<th width="18%"> Всего </th>
			<th width="13%"> Прибыль </th>
		</tr>
	</thead>
	<tbody>
	...
	<thead>
		<tr>
			<th colspan="4" style="border-top:1px solid #999999"> Итог: </th>
