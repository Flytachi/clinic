            ...
            <div class="table-responsive card">
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        foreach ($db->query("SELECT la.id, la.result, la.deviation, $norm, lat.unit FROM laboratory_analyze la LEFT JOIN laboratory_analyze_type lat ON (la.analyze_id = lat.id) WHERE la.visit_id = {$_GET['id']}") as $row) {
                            ?>
                            <tr>
                                <td><?= $i++ ?></td>
