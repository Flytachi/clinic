				            ...
				            <table class="table table-hover">
				                ...
				                <tbody>
									...
									<tr class="record">
										...
										<td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#a<?= $row['id'] ?>"><i class="icon-pencil3"></i></button>
										<a href="deletecustomer.php?id=<?= $row['id'] ?>" id="" class="delbutton" title="Удалить"><button class="btn btn-danger"><i class="icon-trash"></i></button></a></td></td>
									</tr>
									<?php
											}
										?>
