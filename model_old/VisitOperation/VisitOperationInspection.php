...
class VisitOperationInspectionModel extends ModelOld
{
    public $table = 'visit_operation_inspections';
    public $_operation = 'visit_operations';

    public function get_or_404(int $pk)
    {
        global $db;
        $object = $db->query("SELECT * FROM $this->_operation WHERE id = $pk AND completed IS NULL")->fetch(PDO::FETCH_ASSOC);
    ...
    public function form($pk = null)
    {
        ...
        <form method="post" action="<?= add_url() ?>">
            ...
            <input type="hidden" name="operation_id" value="<?= $pk ?>">
