                                ...
                                <div class="col-md-2" style="margin-top: 5px;">
									...
									<div class="form-check">
										<label class="form-check-label">
											<input type="radio" name="gender" <?= ($_SESSION[$form_name]['gender'] == 1) ?'checked': '' ?> value="1" class="form-check-input" name="unstyled-radio-left" checked>
											Мужчина
										</label>
									</div>
									...
									<div class="form-check">
										<label class="form-check-label">
											<input type="radio" name="gender" <?= ($_SESSION[$form_name]['gender'] == 0) ?'checked': '' ?> value="0" class="form-check-input" name="unstyled-radio-left">
											Женщина
										</label>
									</div>
                                </div>
